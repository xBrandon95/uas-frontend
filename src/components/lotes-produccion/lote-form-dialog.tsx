...
import { MultiSelectTipoServicioDinamico } from "@/components/ui/multi-select-tipo-servicio";
                ...
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    ...
                    <p className="text-sm mt-1">
                      ...
                      Disponible:{" "}
                      <strong>{pesoDisponible.toFixed(2)} kg</strong>
                    </p>
                  </AlertDescription>
                </Alert>
              )}
